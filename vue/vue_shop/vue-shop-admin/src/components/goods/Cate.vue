<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 分页区域 -->
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="querInfo.pagenum" :page-sizes="[3, 5, 10, 15]" :page-size="querInfo.pagesize"
...
export default {
  ...
  methods: {
    ...
    // 点击按钮，提交修改分类
    editCateSure() {
      this.$refs.editCateFormRef.validate(async () => {
        // 可以发起修改分类名称的网络请求
