...
gulp.task('themes', () => {
  ...
  function fnCreate (themeList) {
    if (themeList.length >= 1) {
      ...
      console.log('\n')
      console.log(colors.green('-------------------- 待构件，主题 -------------------------'))
      console.log(themeList)
      console.log('\n')
      console.log(colors.green('-------------------- 构件中，主题 -------------------------'))
      console.log(theme)
      console.log('\n')
      ...
      del(styleFileDirTemp)
      console.log('\n')
      console.log(colors.green('-------------------- 构件完毕，删除临时文件 -------------------------'))
      ...
      del(files)
      console.log(colors.green('-------------------- 构件完毕，删除主题独立组件文件 -------------------------'))
      console.log(files)
      console.log('\n')
    }
  }
