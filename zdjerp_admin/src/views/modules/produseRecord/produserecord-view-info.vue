<template>
  <el-dialog :visible.sync="visible" title="查看" :close-on-click-modal="false" :close-on-press-escape="false" width="90%">
    ...
    <el-table show-summary :summary-method="getSummaries" :data="dataList" border style="width: 100%;">
      ...
      <el-table-column prop="specificationType" show-overflow-tooltip label="规格型号" header-align="center" align="center">
      </el-table-column>
      <el-table-column prop="deptName" show-overflow-tooltip label="单位" width="150" header-align="center" align="center">
      </el-table-column>
      <el-table-column prop="quantity" show-overflow-tooltip label="库存数量" width="200" header-align="center" align="center">
      </el-table-column>
      <el-table-column prop="putinquantity" show-overflow-tooltip label="出库数量" width="200" header-align="center" align="center">
      </el-table-column>
      <el-table-column prop="remark" show-overflow-tooltip label="备注" header-align="center" align="center">
      </el-table-column>
    </el-table>
