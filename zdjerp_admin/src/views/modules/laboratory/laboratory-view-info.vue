      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="工具分类" prop="parentName">
            <el-input v-model="dataForm.parentName" :readonly="true" placeholder="实验室工具分类"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="使用部门" prop="useDeptName">
            <el-input v-model="dataForm.useDeptName" :readonly="true" placeholder="使用部门"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="负责人" prop="manager">
            <el-select v-model="dataForm.manager" filterable clearable placeholder="负责人" style="width: 100%" disabled>
              <el-option
