  ...
  <el-dialog :visible.sync="visible" title="产成品列表" :close-on-click-modal="false" :append-to-body="true" width="70%" :close-on-press-escape="false">
    <el-card shadow="never" class="aui-card--fill">
      <div class="mod-laboratory__laboratorystock}">
        ...
        <el-table ref="multipleTable" v-loading="dataListLoading" stripe :row-key="getRowKeys" :data="dataList" border @selection-change="dataListSelectionChangeHandle" style="width: 100%;" :default-sort = "{prop: 'componentSeries', order: 'descending'}">
          ...
          <el-table-column prop="componentSeries" label="系列" sortable header-align="center" align="center" width="150"></el-table-column>
    ...
    getCodeList () {
      if (this.productList) {
        ...
        for (var i = 0; i < this.productList.length; i++) {
          list.push(this.productList[i].materialCoding)
        }
